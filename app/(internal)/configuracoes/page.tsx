...
export default function ConfiguracoesPage() {
    ...
    const [certBlocos, setCertBlocos] = useState<any[]>([])
                ...
                <div className="flex-1">
                    <form onSubmit={handleSave} className="space-y-8">
                        ...
                        {activeTab === 'certificados' && (
                            <div className="animate-in fade-in duration-500 flex flex-col items-center justify-center py-20 gap-8">
                                <div className="w-20 h-20 bg-[#1A3C4A]/5 rounded-[30px] flex items-center justify-center">
                                    <FileText className="w-10 h-10 text-[#1A3C4A]" />
                                </div>
                                <div className="text-center max-w-sm space-y-2">
                                    <h3 className="text-2xl font-black text-[#1A3C4A] tracking-tighter">Editor de Certificados</h3>
                                    <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest leading-relaxed">
                                        Personalize textos, cores, assinaturas e posicionamento dos elementos do certificado
                                    </p>
                                </div>
                                <Link href="/configuracoes/certificados"
                                    className="flex items-center gap-3 px-10 py-5 bg-[#1A3C4A] text-white rounded-[24px] font-black uppercase text-[11px] tracking-[0.2em] hover:bg-[#2D9E6B] transition-all shadow-2xl shadow-black/20">
                                    <FileText className="w-5 h-5" /> Abrir Editor de Certificados
                                </Link>
                            </div>
                        )}
