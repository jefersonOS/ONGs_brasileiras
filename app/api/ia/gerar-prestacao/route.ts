...
export async function POST(req: Request) {
    try {
        ...
        // 3. Preparar Provider de IA
        let modelProvider: any = anthropic('claude-3-5-sonnet-20240620')
        if (cfg.ai_modelo_ativo === 'gpt-4o') modelProvider = openai('gpt-4o')
        if (cfg.ai_modelo_ativo === 'gemini-1.5-pro') modelProvider = google('gemini-1.5-pro')
        ...
        // Extrair JSON do texto (caso a IA mande markdown ou texto extra)
